                ...
                >
                    <MenuItem
                        onClick={() => {
                            ...
                            window.location.href = `http://localhost:8181/auth/oauth/google?next=${currentLocation}`;
                            handleSignInClose();
                        }}
                    >
                        Sign in with Google
                    ...
                    <MenuItem
                        onClick={() => {
                            ...
                            const currentLocation = encodeURIComponent(window.location.href);
                            // Redirect to the OAuth endpoint, passing the current location as "next".
                            window.location.href = `http://localhost:8181/auth/oauth/microsoft?next=${currentLocation}`;
                            handleSignInClose();
                        }}
                    >
